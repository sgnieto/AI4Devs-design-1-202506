...
### Technical Epic Breakdown – Traceability Rule

**Traceability Rule for Technical Epic Breakdowns:**  
Before presenting any technical task breakdown for an epic, the Analyst must:

- Thoroughly review that all user stories and acceptance criteria for the epic are covered by concrete technical tasks.
- Ensure that the traceability between each user story and the backend/frontend technical tasks is precise and correct, not just by numbering but by actual content and intent.
- Include, at the beginning of the breakdown, a clear and up-to-date traceability table mapping each user story/acceptance criterion to the corresponding technical tasks.
- If any gap, overlap, or error in the mapping is detected, it must be corrected before delivering the breakdown.
